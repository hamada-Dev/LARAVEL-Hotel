...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <textarea class="form-control  @error($locale . ' .address') is-invalid  @enderror "
                name=" {{ $locale }}[address]" cols="30"
                rows="10">{{ isset($row) ? $row->translate($locale)->address : old($locale . '.address') }}</textarea>
